...
```javascript
snanmskrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-snanmskrange@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-snanmskrange/tags). For example,

```javascript
snanmskrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-snanmskrange@v0.1.1-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var snanmskrange = require( 'path/to/vendor/umd/stats-strided-snanmskrange/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-snanmskrange@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-snanmskrange.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-snanmskrange

[test-image]: https://github.com/stdlib-js/stats-strided-snanmskrange/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/stats-strided-snanmskrange/actions/workflows/test.yml?query=branch:v0.1.1

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-snanmskrange/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-snanmskrange?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-snanmskrange.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-snanmskrange/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-snanmskrange/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-snanmskrange/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-snanmskrange/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-snanmskrange/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-snanmskrange/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-snanmskrange/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-snanmskrange/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-snanmskrange/main/LICENSE
